...
echo Copying Codec Driver Packages to %PKG_ROOT%\Audio
copy %BUILD_ROOT%\wm8960codec\* %PKG_ROOT%\Audio\ >NUL
if errorlevel 1 (set FAILURE=wm8960 & goto ERROR)
copy %REPO_ROOT%\driver\audio\codec\wm8960\wm8960codec.wm.xml %PKG_ROOT%\Audio\ >NUL
