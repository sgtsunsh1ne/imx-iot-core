...
set DEST=winpe_imx
set FFU_DISK_NUM=1
set WINPE_DRIVE_LETTER=C
set SCRIPT_DIR=%~dp0

:: Defaults for option check
set BUILD_DIR=""
set FIRMWARE_PATH=""
set UEFI_PATH=""
set FFU_PATH=""
...
if NOT %FFU_PATH% == "" (
    ...
    echo timeout /t 10 /nobreak >> %STARTNET_CMD%
...
REM Temporary commented out since mx6pep does not support all SoC now. Otherwise WinPE crashes on unsupported platform by mx6pep.
REM call :GETPACKAGE NXP.iMX.mx6pep.cab || goto err
...
:USAGE
    ...
    echo                                     WinPE is installed. Defaults to C.
