...
:APPLY
    ...
    dd if=%DEST%"\flash.bin" of=\\.\PhysicalDrive%DISK_NUM% bs=512 seek=66 skip=0 || goto err
    dd if=%DEST%"\uefi.fit" of=\\.\PhysicalDrive%DISK_NUM% bs=1024 seek=2176 skip=0 || goto err
    echo Success
    exit /b 0
