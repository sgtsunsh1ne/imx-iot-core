...
Abstract:
    ...
    i.MX6 6Solo/6DualLite SDMA controller configuration.
...
#ifndef _IMX6_SDMA_SOLO_DUALL_HW_H
#define _IMX6_SDMA_SOLO_DUALL_HW_H
...
//
typedef enum _IMX6SDL_SDMA_EVENT_ID {
    IMX6SDL_SDMA_EVENT_VPU = 0,
    IMX6SDL_SDMA_EVENT_I2C4 = 1,
    IMX6SDL_SDMA_EVENT_IPU1_HDMI_AUDIO = 2,
    IMX6SDL_SDMA_EVENT_ECSPI1_RX_I2C3 = 3,
    IMX6SDL_SDMA_EVENT_ECSPI1_TX_I2C2 = 4,
    IMX6SDL_SDMA_EVENT_ECSPI2_RX_I2C1 = 5,
    IMX6SDL_SDMA_EVENT_ECSPI2_TX = 6,
    IMX6SDL_SDMA_EVENT_ECSPI3_RX = 7,
    IMX6SDL_SDMA_EVENT_ECSPI3_TX = 8,
    IMX6SDL_SDMA_EVENT_ECSPI4_RX_EPIT2 = 9,
    IMX6SDL_SDMA_EVENT_ECSPI4_TX_I2C1_ALT = 10,
    IMX6SDL_SDMA_EVENT_RESERVED11 = 11,
    IMX6SDL_SDMA_EVENT_RESERVED12 = 12,
    IMX6SDL_SDMA_EVENT_GPT = 13,
    IMX6SDL_SDMA_EVENT_SPDIF_RX_IOMUX = 14,
    IMX6SDL_SDMA_EVENT_SPDIF_TX = 15,
    IMX6SDL_SDMA_EVENT_EPIT1 = 16,
    IMX6SDL_SDMA_EVENT_ASRC_RXA = 17,
    IMX6SDL_SDMA_EVENT_ASRC_RXB = 18,
    IMX6SDL_SDMA_EVENT_ASRC_RXC = 19,
    IMX6SDL_SDMA_EVENT_ASRC_TXA = 20,
    IMX6SDL_SDMA_EVENT_ASRC_TXB = 21,
    IMX6SDL_SDMA_EVENT_ASRC_TXC = 22,
    IMX6SDL_SDMA_EVENT_ESAI_RX_I2C3_ALT = 23,
    IMX6SDL_SDMA_EVENT_ESAI_TX = 24,
    IMX6SDL_SDMA_EVENT_UART1_RX = 25,
    IMX6SDL_SDMA_EVENT_UART1_TX = 26,
    IMX6SDL_SDMA_EVENT_UART2_RX = 27,
    IMX6SDL_SDMA_EVENT_UART2_TX = 28,
    IMX6SDL_SDMA_EVENT_UART3_RX = 29,
    IMX6SDL_SDMA_EVENT_UART3_TX = 30,
    IMX6SDL_SDMA_EVENT_UART4_RX = 31,
    IMX6SDL_SDMA_EVENT_UART4_TX = 32,
    IMX6SDL_SDMA_EVENT_UART5_RX = 33,
    IMX6SDL_SDMA_EVENT_UART5_TX = 34,
    IMX6SDL_SDMA_EVENT_SSI1_RX1 = 35,
    IMX6SDL_SDMA_EVENT_SSI1_TX1 = 36,
    IMX6SDL_SDMA_EVENT_SSI1_RX0 = 37,
    IMX6SDL_SDMA_EVENT_SSI1_TX0 = 38,
    IMX6SDL_SDMA_EVENT_SSI2_RX1 = 39,
    IMX6SDL_SDMA_EVENT_SSI2_TX1 = 40,
    IMX6SDL_SDMA_EVENT_SSI2_RX0 = 41,
    IMX6SDL_SDMA_EVENT_SSI2_TX0 = 42,
    IMX6SDL_SDMA_EVENT_SSI3_RX1 = 43,
    IMX6SDL_SDMA_EVENT_SSI3_TX1 = 44,
    IMX6SDL_SDMA_EVENT_SSI3_RX0 = 45,
    IMX6SDL_SDMA_EVENT_SSI3_TX0 = 46,
    IMX6SDL_SDMA_EVENT_DCTP = 47
} IMX6SDL_SDMA_EVENT_ID;
...
#define IMX6SDL_DMA_EVENT_MUX_SEL0_IPU1 0
#define IMX6SDL_DMA_EVENT_MUX_SEL0_HDMI 1

#define IMX6SDL_DMA_EVENT_MUX_SEL1_ECSPI1_RX 0
#define IMX6SDL_DMA_EVENT_MUX_SEL1_I2C3 1

#define IMX6SDL_DMA_EVENT_MUX_SEL2_ECSPI1_TX 0
#define IMX6SDL_DMA_EVENT_MUX_SEL2_I2C2 1

#define IMX6SDL_DMA_EVENT_MUX_SEL3_ECSPI2_RX 0
#define IMX6SDL_DMA_EVENT_MUX_SEL3_I2C1 1

#define IMX6SDL_DMA_EVENT_MUX_SEL4_ECSPI4_TX 0
#define IMX6SDL_DMA_EVENT_MUX_SEL4_I2C1 1

#define IMX6SDL_DMA_EVENT_MUX_SEL5_ECSPI4_RX 0
#define IMX6SDL_DMA_EVENT_MUX_SEL5_EPIT2 1

#define IMX6SDL_DMA_EVENT_MUX_SEL6_ESAI 0
#define IMX6SDL_DMA_EVENT_MUX_SEL6_I2C3 1

#define IMX6SDL_DMA_EVENT_MUX_SEL7_SPDIF_RX 0
#define IMX6SDL_DMA_EVENT_MUX_SEL7_EXT1 1
...
#define IMX6SDL_ESAI_BASE_ADDRESS   0x02024000UL
#define IMX6SDL_ESAI_ETDR_OFFSET    0UL
...
//
// IMX6 Solo/Dual lite DMA request -> Channel configuration
//

SDMA_CHANNEL_CONFIG Imx6SdlDmaReqToChannelConfig[] = {
    ...
    // (4) SDMA_REQ_ECSPI1_RX -> Event 3
    {
        ...
        {
            {
                IMX6SDL_SDMA_EVENT_ECSPI1_RX_I2C3,
                DMA_EVENT_MUX_SEL1,
                IMX6SDL_DMA_EVENT_MUX_SEL1_ECSPI1_RX
            },
        },
    },
    ...
    // (5) SDMA_REQ_ECSPI1_TX -> Event 4
    {
        ...
        {
            {
                IMX6SDL_SDMA_EVENT_ECSPI1_TX_I2C2,
                DMA_EVENT_MUX_SEL2,
                IMX6SDL_DMA_EVENT_MUX_SEL2_ECSPI1_TX
            },
        },
    },
    ...
    // (14) SDMA_REQ_I2C1_RX -> Event 5/10
    {
        ...
        {
            {
                IMX6SDL_SDMA_EVENT_ECSPI2_RX_I2C1,
                DMA_EVENT_MUX_SEL3,
                IMX6SDL_DMA_EVENT_MUX_SEL3_I2C1
            },
        },
    },
        ...
        {
            {
                IMX6SDL_SDMA_EVENT_ECSPI1_TX_I2C2,
                DMA_EVENT_MUX_SEL4,
                IMX6SDL_DMA_EVENT_MUX_SEL4_I2C1
            }
        },
    },
        ...
        {
            {
                IMX6SDL_SDMA_EVENT_ECSPI1_RX_I2C3,
                DMA_EVENT_MUX_SEL1,
                IMX6SDL_DMA_EVENT_MUX_SEL1_I2C3
            }
        },
    },
    ...
    // (30) SDMA_REQ_SPDIF_RX -> Event 14
    {
        ...
        {
            {
                IMX6SDL_SDMA_EVENT_SPDIF_RX_IOMUX,
                DMA_EVENT_MUX_SEL7,
                //IMX6DL_DMA_EVENT_MUX_SEL7_SPDIF_RX
            },
        },
    },
    ...
    // (33) SDMA_REQ_EPIT2 -> Event 9
    {
        ...
        {
            {
                IMX6SDL_SDMA_EVENT_ECSPI4_RX_EPIT2,
                DMA_EVENT_MUX_SEL5,
                IMX6SDL_DMA_EVENT_MUX_SEL5_EPIT2
            },
        },
    },
    ...
    // (41) SDMA_REQ_ESAI_RX -> Event 23
    {
        ...
        {
            {
                IMX6SDL_SDMA_EVENT_ESAI_RX_I2C3_ALT,
                DMA_EVENT_MUX_SEL6,
                IMX6SDL_DMA_EVENT_MUX_SEL6_ESAI
            }
        },
    },
...
ULONG Imx6SdlDmaReqMax = ARRAYSIZE(Imx6SdlDmaReqToChannelConfig) - 1;


#endif // !_IMX6_SDMA_SOLO_DUALL_HW_H
