...
Abstract:
  ...
  i.MX6UL SDMA controller configuration.
...
#ifndef  _IMX6_SDMA_UL_HW_H
#define  _IMX6_SDMA_UL_HW_H
...
//
// IMX6UL SDMA event definitions.
// These values match the datasheet.
//
typedef enum _IMX6UL_SDMA_EVENT_ID {
  IMX6UL_SDMA_EVENT_UART6_RX_SIM2_RX = 0,
  IMX6UL_SDMA_EVENT_ADC1 = 1,
  IMX6UL_SDMA_EVENT_EPIT2_PXP = 2,
  IMX6UL_SDMA_EVENT_ECSPI1_RX = 3,
  IMX6UL_SDMA_EVENT_ECSPI1_TX = 4,
  IMX6UL_SDMA_EVENT_ECSPI2_RX = 5,
  IMX6UL_SDMA_EVENT_ECSPI2_TX = 6,
  IMX6UL_SDMA_EVENT_ECSPI3_RX_I2C1 = 7,
  IMX6UL_SDMA_EVENT_ECSPI3_TX_I2C2 = 8,
  IMX6UL_SDMA_EVENT_ECSPI4_RX_I2C3 = 9,
  IMX6UL_SDMA_EVENT_ECSPI4_TX_I2C4 = 10,
  IMX6UL_SDMA_EVENT_QSPI_RX = 11,
  IMX6UL_SDMA_EVENT_QSPI_TX = 12,
  IMX6UL_SDMA_EVENT_ADC2_TSC = 13,
  IMX6UL_SDMA_EVENT_MUX_BOTTOM_1 = 14,
  IMX6UL_SDMA_EVENT_MUX_BOTTOM_2 = 15,
  IMX6UL_SDMA_EVENT_EPIT1_CSI = 16,
  IMX6UL_SDMA_EVENT_ASRC_RXA = 17,
  IMX6UL_SDMA_EVENT_ASRC_RXB = 18,
  IMX6UL_SDMA_EVENT_ASRC_RXC = 19,
  IMX6UL_SDMA_EVENT_ASRC_TXA = 20,
  IMX6UL_SDMA_EVENT_ASRC_TXB = 21,
  IMX6UL_SDMA_EVENT_ASRC_TXC = 22,
  IMX6UL_SDMA_EVENT_GPT1 = 23,
  IMX6UL_SDMA_EVENT_GPT2_LCDIF = 24,
  IMX6UL_SDMA_EVENT_UART1_RX = 25,
  IMX6UL_SDMA_EVENT_UART1_TX = 26,
  IMX6UL_SDMA_EVENT_UART2_RX = 27,
  IMX6UL_SDMA_EVENT_UART2_TX = 28,
  IMX6UL_SDMA_EVENT_UART3_RX = 29,
  IMX6UL_SDMA_EVENT_UART3_TX = 30,
  IMX6UL_SDMA_EVENT_UART4_RX = 31,
  IMX6UL_SDMA_EVENT_UART4_TX = 32,
  IMX6UL_SDMA_EVENT_UART5_RX_SIM1_RX = 33,
  IMX6UL_SDMA_EVENT_UART5_TX_SIM1_TX = 34,
  IMX6UL_SDMA_EVENT_SAI1_RX = 35,
  IMX6UL_SDMA_EVENT_SAI1_TX = 36,
  IMX6UL_SDMA_EVENT_SAI2_RX = 37,
  IMX6UL_SDMA_EVENT_SAI2_TX = 38,
  IMX6UL_SDMA_EVENT_SAI3_RX = 39,
  IMX6UL_SDMA_EVENT_SAI3_TX = 40,
  IMX6UL_SDMA_EVENT_SPDIF_RX = 41,
  IMX6UL_SDMA_EVENT_SPDIF_TX = 42,
  IMX6UL_SDMA_EVENT_UART7_RX_ENET1_EV0 = 43,
  IMX6UL_SDMA_EVENT_UART7_TX_ENET1_EV1 = 44,
  IMX6UL_SDMA_EVENT_UART8_RX_ENET2_EV0 = 45,
  IMX6UL_SDMA_EVENT_UART8_TX_ENET2_EV1 = 46,
  IMX6UL_SDMA_EVENT_UART6_TX_SIM_TX = 47
} IMX6UL_SDMA_EVENT_ID;


//
// Shared DMA event selection
//
#define IMX6UL_DMA_EVENT_MUX_SEL15_UART6_TX 0
#define IMX6UL_DMA_EVENT_MUX_SEL15_ESAI_TX 1

#define IMX6UL_DMA_EVENT_MUX_SEL14_UART6_RX 0
#define IMX6UL_DMA_EVENT_MUX_SEL14_ESAI_RX 1

#define IMX6UL_DMA_EVENT_MUX_SEL13_UART5_TX 0
#define IMX6UL_DMA_EVENT_MUX_SEL13_EPDC 1

#define IMX6UL_DMA_EVENT_MUX_SEL11_UART8_TX 0
#define IMX6UL_DMA_EVENT_MUX_SEL11_ENET2_EV1 1

#define IMX6UL_DMA_EVENT_MUX_SEL10_UART8_RX 0
#define IMX6UL_DMA_EVENT_MUX_SEL10_ENET2_EV0 1

#define IMX6UL_DMA_EVENT_MUX_SEL9_UART7_TX 0
#define IMX6UL_DMA_EVENT_MUX_SEL9_ENET1_EV1 1

#define IMX6UL_DMA_EVENT_MUX_SEL8_UART7_RX 0
#define IMX6UL_DMA_EVENT_MUX_SEL8_ENET1_EV0 1

#define IMX6UL_DMA_EVENT_MUX_SEL7_ADC2 0
#define IMX6UL_DMA_EVENT_MUX_SEL7_TSC 1

#define IMX6UL_DMA_EVENT_MUX_SEL6_GPT2 0
#define IMX6UL_DMA_EVENT_MUX_SEL6_LCDIF 1

#define IMX6UL_DMA_EVENT_MUX_SEL5_EPIT1 0
#define IMX6UL_DMA_EVENT_MUX_SEL5_CSI 1

#define IMX6UL_DMA_EVENT_MUX_SEL4_ECSPI4_TX 0
#define IMX6UL_DMA_EVENT_MUX_SEL4_I2C4 1

#define IMX6UL_DMA_EVENT_MUX_SEL3_ECSPI4_RX 0
#define IMX6UL_DMA_EVENT_MUX_SEL3_I2C3 1

#define IMX6UL_DMA_EVENT_MUX_SEL2_ECSPI3_TX 0
#define IMX6UL_DMA_EVENT_MUX_SEL2_I2C2 1

#define IMX6UL_DMA_EVENT_MUX_SEL1_ECSPI3_RX 0
#define IMX6UL_DMA_EVENT_MUX_SEL1_I2C1 1

#define IMX6UL_DMA_EVENT_MUX_SEL0_EPIT2 0
#define IMX6UL_DMA_EVENT_MUX_SEL0_PXP 1
...
//
// IMX6UL DMA request -> Channel configuration
//
...
SDMA_CHANNEL_CONFIG Imx6UlDmaReqToChannelConfig[] = {
  ...
  // (8) SDMA_REQ_ECSPI3_RX -> Event 7
  {
    ...
    {
      {
        IMX6UL_SDMA_EVENT_ECSPI3_RX_I2C1,
        DMA_EVENT_MUX_SEL1,
        IMX6UL_DMA_EVENT_MUX_SEL1_ECSPI3_RX
      },
    },
  },
  ...
  // (9) SDMA_REQ_ECSPI3_TX -> Event 8
  {
    ...
    {
      {
        IMX6UL_SDMA_EVENT_ECSPI3_TX_I2C2,
        DMA_EVENT_MUX_SEL2,
        IMX6UL_DMA_EVENT_MUX_SEL2_ECSPI3_TX
      },
    },
  },
  ...
  // (10) SDMA_REQ_ECSPI4_RX -> Event 9
  {
    ...
    {
      {
        IMX6UL_SDMA_EVENT_ECSPI4_RX_I2C3,
        DMA_EVENT_MUX_SEL3,
        IMX6UL_DMA_EVENT_MUX_SEL3_ECSPI4_RX
      }
    },
  },
  ...
  // (11) SDMA_REQ_ECSPI4_TX -> Event 10
  {
    ...
    {
      {
        IMX6UL_SDMA_EVENT_ECSPI4_TX_I2C4,
        DMA_EVENT_MUX_SEL4,
        IMX6UL_DMA_EVENT_MUX_SEL4_ECSPI4_TX
      }
    },
  },
    ...
    {
      {
        IMX6UL_SDMA_EVENT_ECSPI3_RX_I2C1,
        DMA_EVENT_MUX_SEL1,
        IMX6UL_DMA_EVENT_MUX_SEL1_I2C1
      },
    },
  },
    ...
    {
      {
        IMX6UL_SDMA_EVENT_ECSPI3_TX_I2C2,
        DMA_EVENT_MUX_SEL2,
        IMX6UL_DMA_EVENT_MUX_SEL2_I2C2
      }
    },
  },
    ...
    {
      {
        IMX6UL_SDMA_EVENT_ECSPI4_RX_I2C3,
        DMA_EVENT_MUX_SEL3,
        IMX6UL_DMA_EVENT_MUX_SEL3_I2C3
      }
    },
  },
  ...
  // (28) SDMA_REQ_UART5_RX -> Event 33
  {
    ...
    {
      {
        IMX6UL_SDMA_EVENT_UART5_RX_SIM1_RX,
        DMA_EVENT_EXCLUSIVE
      },
    },
  },
  ...
  // (29) SDMA_REQ_UART5_TX -> Event 34
  {
    ...
    {
      {
        IMX6UL_SDMA_EVENT_UART5_TX_SIM1_TX,
        DMA_EVENT_MUX_SEL13,
        IMX6UL_DMA_EVENT_MUX_SEL13_UART5_TX
      },
    },
  },
  ...
  // (32) SDMA_REQ_EPIT1 -> Event 16
  {
    ...
    {
      {
        IMX6UL_SDMA_EVENT_EPIT1_CSI,
        DMA_EVENT_MUX_SEL5,
        IMX6UL_DMA_EVENT_MUX_SEL5_EPIT1
      },
    },
  },
  ...
  // (41) SDMA_REQ_ESAI_RX -> Event 0
  {
    ...
    {
      {
        IMX6UL_SDMA_EVENT_UART6_RX_SIM2_RX,
        DMA_EVENT_MUX_SEL14,
        IMX6UL_DMA_EVENT_MUX_SEL14_ESAI_RX
      },
    },
  },
  ...
  // (42) SDMA_REQ_ESAI_TX -> Event 47
  {
    ...
    {
      {
        IMX6UL_SDMA_EVENT_UART6_TX_SIM_TX,
        DMA_EVENT_MUX_SEL15,
        IMX6UL_DMA_EVENT_MUX_SEL15_ESAI_TX
      },
    },
  },
    ...
    {
      {
        IMX6UL_SDMA_EVENT_UART6_RX_SIM2_RX,
        DMA_EVENT_MUX_SEL14,
        IMX6UL_DMA_EVENT_MUX_SEL14_UART6_RX
      },
    },
  },
    ...
    {
      {
        IMX6UL_SDMA_EVENT_UART6_TX_SIM_TX,
        DMA_EVENT_MUX_SEL15,
        IMX6UL_DMA_EVENT_MUX_SEL15_UART6_TX
      },
    },
  },
  ...
  // (63) SDMA_REQ_ADC2 -> Event 13
  {
    ...
    {
      {
        IMX6UL_SDMA_EVENT_ADC2_TSC,
        DMA_EVENT_MUX_SEL7,
        IMX6UL_DMA_EVENT_MUX_SEL7_ADC2
      },
    },
  },
    ...
    {
      {
        IMX6UL_SDMA_EVENT_ECSPI4_TX_I2C4,
        DMA_EVENT_MUX_SEL4,
        IMX6UL_DMA_EVENT_MUX_SEL4_I2C4
      },
    },
  },
  ...
  // (68) SDMA_REQ_PXP -> Event 2
  {
    ...
    {
      {
        IMX6UL_SDMA_EVENT_EPIT2_PXP,
        DMA_EVENT_MUX_SEL0,
        IMX6UL_DMA_EVENT_MUX_SEL0_PXP
      },
    },
  },
  ...
  // (69) SDMA_REQ_LCDIF1 -> Event 24
  {
    ...
    {
      {
        IMX6UL_SDMA_EVENT_GPT2_LCDIF,
        DMA_EVENT_MUX_SEL6,
        IMX6UL_DMA_EVENT_MUX_SEL6_LCDIF
      },
    },
  },
  ...
  // (87) SDMA_REQ_UART7_RX -> Event 43
  {
    ...
    {
      {
        IMX6UL_SDMA_EVENT_UART7_RX_ENET1_EV0,
        DMA_EVENT_MUX_SEL8,
        IMX6UL_DMA_EVENT_MUX_SEL8_UART7_RX
      },
    },
  },
  ...
  // (88) SDMA_REQ_UART7_TX -> Event 44
  {
    ...
    {
      {
        IMX6UL_SDMA_EVENT_UART7_TX_ENET1_EV1,
        DMA_EVENT_MUX_SEL9,
        IMX6UL_DMA_EVENT_MUX_SEL9_UART7_TX
      },
    },
  },
    ...
    {
      {
        IMX6UL_SDMA_EVENT_GPT2_LCDIF,
        DMA_EVENT_MUX_SEL6,
        IMX6UL_DMA_EVENT_MUX_SEL6_GPT2
      },
    },
  },
...
ULONG Imx6UlDmaReqMax = ARRAYSIZE(Imx6UlDmaReqToChannelConfig) - 1;


#endif // ! _IMX6_SDMA_UL_HW_H
